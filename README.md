...
One way to stream logs in local development is to run some dockerized application of your choice on a local VM (or just on metal), and use [Alloy](https://grafana.com/docs/alloy/latest/) to collect and push the Docker logs.
